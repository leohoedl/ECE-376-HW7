	...
	;This licence will expire on Mon, 09 Mar 2020
	...
	; Compiler options:
	;
	; -oLoadedDie.cof -mLoadedDie.map --summary=default --output=default \
	; Loaded_Die.p1 --chip=18F4620 -P --runtime=default --opt=default \
